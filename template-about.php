							...
							<div class="entry-content main-entry-content col-md-12">
								...
								<div class="row aboutushero about1">
									<div class="col-xs-12 col-sm-12 col-md-12 text-center">
										<div class="herocaption">
											<h1>About Us</h1>
											<p>NECTAR7 is a global company that focuses on bringing life-enhancing, science-based nutrition and lifestyle supplements to the market. Our products are based on the latest scientific studies and breakthroughs for one reason: to give you a higher quality of life.</p>
										</div>
									</div>
								</div>
								...
								<div class="row aboutproduct">
									<div class="col-xs-12 col-sm-6 col-md-7 textcol">
										<p>NECTAR7 specializes in performance-based nutrition for a healthy lifestyle. Backed by research from leading universities and some of the world's leading scientists, we sell performance-based nutrition supplements to help you experience life to the fullest.</p>
										<p><a href="<?php bloginfo('url'); ?>/nectar7-niagen-product-2/" class="btn btn-primary">LEARN MORE ABOUT NECTAR7 <span>Niagen&reg;</span></a></p>
									</div>
									...
									<div class="col-xs-12 col-sm-12 col-md-12 aboutushero about3">
										<div class="row">
											<div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
												<p>For strategic partnerships and relationships with NECTAR7, both domestic and global, please contact us by calling 1-800-662-8617.</p>
											</div>
										</div>
									</div>
								</div>
